...
O algoritmos é o fundamentos da ciência da computação. Algoritmos só existem com a função de resolver problemas. Pra ser um programador, você precisa desenvolver a sua capacidade de resolver problemas e transformá-lo em um algoritmo. $$x_{problema}\rightarrow f(x)_{algoritmo}\rightarrow y_{solução}$$
